...
TRAIN_PROTOTXT_BASE="../conf/vgg-16-encoder-decoder-contour-pascal-train-"$METHODOLOGY_PARAM".prototxt"
cp "$TRAIN_PROTOTXT_BASE" "$TRAIN_PROTOTXT_PATH"

SOLVER_PROTOTXT_BASE=$( < ../conf/vgg-16-encoder-decoder-contour_solver.prototxt )
