...
if [ "$COLOR_PARAM" = "RGB" ]; then
    TRAIN_PROTOTXT_BASE=${TRAIN_PROTOTXT_BASE//\[TRANSFORM_MEAN_VALUE\]/"mean_value: 104.00699\n    mean_value: 116.66877\n    mean_value: 122.67892"}
else
    TRAIN_PROTOTXT_BASE=${TRAIN_PROTOTXT_BASE//\[TRANSFORM_MEAN_VALUE\]/""}
fi

echo -e "$TRAIN_PROTOTXT_BASE" > $TRAIN_PROTOTXT_PATH
