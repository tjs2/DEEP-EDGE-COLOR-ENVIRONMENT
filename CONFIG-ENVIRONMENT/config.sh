...
git -C $CODES_FOLDER_CONF"/"$HED_CODE_FOLDER_CONF checkout -B $HED_CODE_GIT_BRANCH_CONF

git clone $CEDN_CODE_GIT_URL_CONF $CODES_FOLDER_CONF"/"$CEDN_CODE_FOLDER_CONF
git -C $CODES_FOLDER_CONF"/"$CEDN_CODE_FOLDER_CONF checkout -B $CEDN_CODE_GIT_BRANCH_CONF
